...
\begin{figure}
    \includegraphics[width=1\linewidth]{adypu-logo.png}
\end{figure}
    


\title{CyberGuard: A Comprehensive Cybercrime Prevention and Reporting Web Application}
\author{Priyanshu Kumar Sharma | 2022-B-17102004A \\ Vaibhav Gulge | 2022-B-08062004A \\ Prof: Ravi Khatri \\ BTech IT (CTIS) | SEM: 7}
\date{\today}
...
This is to certify that the project entitled \textbf{"CyberGuard: A Comprehensive Cybercrime Prevention and Reporting Web Application"} submitted by \textbf{Priyanshu Kumar Sharma (2022-B-17102004A)} and \textbf{Vaibhav Gulge (2022-B-08062004A)} in partial fulfillment of the requirements for the award of Bachelor of Technology degree in Information Technology (Cyber Technology and Information Security) at Ajeenkya DY Patil University, Pune is a record of bonafide work carried out by them under my supervision and guidance.
...
Project Guide \\
Department of IT (CTIS) \\
Ajeenkya DY Patil University

\vspace{2cm}

\noindent
\textbf{Date:} \underline{\hspace{3cm}} \hspace{2cm} \textbf{Place:} Pune
...
We, \textbf{Priyanshu Kumar Sharma (2022-B-17102004A)} and \textbf{Vaibhav Gulge (2022-B-08062004A)}, students of Bachelor of Technology in Information Technology (Cyber Technology and Information Security), Ajeenkya DY Patil University, Pune, hereby declare that the project work entitled \textbf{"CyberGuard: A Comprehensive Cybercrime Prevention and Reporting Web Application"} submitted in partial fulfillment of the requirements for the award of the degree of Bachelor of Technology is the result of our own work carried out under the supervision of \textbf{Prof. Ravi Khatri}.
...
We have followed all ethical practices while carrying out this research work and have properly cited and referenced all sources used in this project.

\vspace{3cm}

\noindent
\begin{tabular}{@{}ll}
\textbf{Priyanshu Kumar Sharma} & \textbf{Vaibhav Gulge} \\
Roll No: 2022-B-17102004A & Roll No: 2022-B-08062004A \\
\end{tabular}
...
This project wouldn't have been possible without help from many people.

\vspace{0.5cm}

First, we want to thank our project guide, \textbf{Prof. Ravi Khatri}. He guided us through countless challenges during development and his cybersecurity expertise really shaped how we approached security in the application. Whenever we got stuck on a problem, his suggestions pointed us in the right direction.

\vspace{0.5cm}



We would like to thank \textbf{Ajeenkya DY Patil University} for providing an excellent academic environment and infrastructure that enabled us to pursue this research work.

\vspace{0.5cm}

Our sincere thanks to all the faculty members of the Department of IT (CTIS) for their valuable suggestions and support during various stages of this project.

\vspace{0.5cm}

We are thankful to our fellow students and friends who provided constructive feedback during the development and testing phases of the application.

\vspace{0.5cm}

We acknowledge the open-source community for providing excellent tools, frameworks, and libraries that made this project possible, including Node.js, Express.js, MySQL, PostgreSQL, and various other technologies.

\vspace{0.5cm}

Finally, we express our deepest gratitude to our families for their unwavering support, patience, and encouragement throughout our academic journey.

\vspace{2cm}

\noindent
\textbf{Priyanshu Kumar Sharma \\ Vaibhav Gulge}

\begin{abstract}
Cybercrime is becoming a massive problem in today's digital world. Experts predict damages could hit \$10.5 trillion per year by 2025. When we looked at existing reporting systems, we found they're often too complicated and bureaucratic, which stops people from reporting crimes. That's why we created CyberGuard - a web application that makes it easier for victims to report cybercrimes and for law enforcement to manage these cases.

We built the system using Node.js and Express.js with a three-tier architecture. The platform lets users report different types of cybercrimes like phishing, identity theft, fraud, and cyberbullying. Users can attach evidence files, track their case status in real-time, and access educational resources about staying safe online. We also added role-based access so admins can manage reports efficiently.

Security was crucial since we're handling sensitive data. We implemented bcrypt for password hashing, followed OWASP guidelines for input validation, and used HTTP-only cookies for sessions. The application runs on Render.com's cloud infrastructure, which gives us good scalability.

We tested everything thoroughly - functionality, security, performance, and usability. The results were encouraging: page loads under 2 seconds, handles multiple users simultaneously, and works well on different devices. Both tech-savvy and non-technical users found it easy to navigate.

This project fills a real gap in cybersecurity infrastructure by making reporting accessible to everyone. Down the road, we're planning to add mobile apps, better analytics, and integrate with other cybersecurity systems.
\end{abstract}
...
CyberGuard started from a simple observation: reporting cybercrimes is way too complicated. During our research, we talked to people who'd been victims of online fraud and phishing attacks. Many told us they didn't bother reporting because the process seemed overwhelming. That's when we decided to build something better.

Our goal was straightforward - create a web platform where anyone can report cybercrimes without needing a computer science degree. We wanted to connect victims with law enforcement more effectively while also teaching people how to protect themselves online. The application needed to be secure (obviously, given the sensitive nature of the data) but also simple enough for your grandmother to use.

We spent several months building this full-stack application using Node.js and Express.js. The frontend uses responsive design so it works on phones, tablets, and computers. We deployed everything on cloud infrastructure to ensure it stays online and can handle traffic spikes. The system now supports various cybercrime types - from phishing and identity theft to cyberbullying and ransomware. Users can upload evidence, track their cases, and admins get tools to manage everything efficiently.ment.

\section{Background and Need for the Project}
...
According to recent statistics from cybersecurity organizations, cybercrime damages are projected to reach \$10.5 trillion annually by 2025, with financial losses running into trillions of dollars annually. The types of cybercrimes have evolved from simple email scams to complex multi-stage attacks involving social engineering, advanced persistent threats, and sophisticated malware campaigns.
...
The CyberGuard project addresses critical societal needs in the digital age:

\textbf{Public Safety:} By providing an accessible platform for reporting cybercrimes, the system contributes to public safety by enabling law enforcement to identify patterns, track criminals, and prevent future incidents.

\textbf{Victim Support:} The platform offers victims a safe, confidential way to report incidents while providing educational resources to prevent future victimization.

\textbf{Law Enforcement Support:} The structured data collection and case management tools help law enforcement agencies efficiently process and investigate cybercrime reports.

\textbf{Community Awareness:} Educational resources and prevention tips help build community resilience against cyber threats.

\textbf{Data-Driven Policy:} Aggregated reporting data can inform policy decisions and resource allocation for cybersecurity initiatives.

\section{Problem Statement}

The current cybercrime reporting ecosystem faces several critical challenges:

\begin{itemize}
\item \textbf{Accessibility Barriers:} Existing systems are often designed for technical users, creating barriers for ordinary citizens
\item \textbf{Fragmented Channels:} Victims struggle to identify appropriate authorities for different cybercrime types
\item \textbf{Lack of Transparency:} Limited visibility into case progress leaves victims uncertain about report status
\item \textbf{Insufficient Evidence Collection:} Victims lack guidance on proper digital evidence preservation
\item \textbf{Limited Education:} Gap in accessible cybersecurity education for prevention
\end{itemize}
...
\begin{itemize}
\item Develop a user-friendly web application for cybercrime reporting accessible to all skill levels
\item Implement secure authentication and authorization systems
\item Create comprehensive incident reporting forms
\item Establish robust case management system for administrators
\item Provide educational resources and prevention tips
\end{itemize}

\subsection{Secondary Objectives}
\begin{itemize}
\item Deploy on cloud infrastructure for high availability
\item Implement responsive design for all devices
\item Establish logging and monitoring systems
\item Create detailed documentation
\item Develop API endpoints for future integrations
\end{itemize}
...
\subsection{Scope}
\begin{itemize}
\item Web-based cybercrime reporting platform
\item User registration and authentication
\item Multiple cybercrime category support
\item Evidence file upload capabilities
\item Admin dashboard for case management
\item Educational content management
\item Cloud deployment with database support
\end{itemize}

\subsection{Limitations}
\begin{itemize}
\item No real-time chat support in current version
\item Limited to English language
\item No mobile native application
\item No integration with external law enforcement systems
\item Manual admin response required for case updates
\end{itemize}
...
\subsection{Government Cybercrime Reporting Systems}

Government-operated systems such as the FBI's Internet Crime Complaint Center (IC3) and India's Cybercrime Portal provide official channels for reporting cybercrimes. These systems offer:

\begin{itemize}
\item Official authority and legal backing
\item Direct connection to law enforcement
\item Comprehensive data collection
\item National-level coordination
\end{itemize}
...
\item Technical jargon that confuses non-technical users
\end{itemize}

\subsection{Private Sector Solutions}

Cybersecurity companies and technology firms have developed various reporting platforms:

\begin{itemize}
\item More user-friendly interfaces
\item Better mobile support
...
Limitations include:
\begin{itemize}
\item Lack of official authority
\item Limited investigative capabilities
\item Privacy concerns with private data handling
\item Cost barriers for some services
\end{itemize}

\subsection{Academic Research}

Research studies have identified key factors for effective cybercrime reporting:

\begin{itemize}
\item User experience design significantly impacts reporting rates
\item Trust and credibility are crucial for victim engagement
\item Educational components improve prevention
\item Mobile accessibility increases reporting
\end{itemize}

\section{Gaps in Current Solutions}

\begin{enumerate}
\item \textbf{Usability Gap:} Most systems prioritize functionality over user experience
\item \textbf{Transparency Gap:} Limited visibility into case progress and outcomes
\item \textbf{Education Gap:} Insufficient integration of prevention education with reporting
\item \textbf{Accessibility Gap:} Poor mobile support and complex interfaces
\item \textbf{Feedback Gap:} Minimal communication between victims and investigators
\end{enumerate}

\section{Justification for Proposed Work}

CyberGuard addresses identified gaps by:

\begin{itemize}
\item \textbf{User-Centered Design:} Intuitive interface for all skill levels
\item \textbf{Transparency:} Real-time case tracking and status updates
\item \textbf{Integrated Education:} Prevention tips alongside reporting
\item \textbf{Responsive Design:} Full functionality across all devices
\item \textbf{Open Communication:} Admin response system for victim updates
\item \textbf{Modern Technology:} Scalable, secure, cloud-based architecture
\end{itemize}
...
\begin{itemize}
\item \textbf{Runtime:} Node.js v18+ for server-side JavaScript execution
\item \textbf{Framework:} Express.js for web application framework
\item \textbf{Database:} MySQL/PostgreSQL for data persistence
\item \textbf{Authentication:} bcrypt for password hashing
\item \textbf{Session Management:} express-session with secure cookies
\end{itemize}

\subsection{Frontend Technologies}
\begin{itemize}
\item \textbf{Templating:} EJS (Embedded JavaScript)
\item \textbf{Styling:} Tailwind CSS for responsive design
\item \textbf{JavaScript:} Vanilla JS for client-side interactions
\item \textbf{Icons:} Font Awesome for UI icons
\end{itemize}

\subsection{Security Tools}
\begin{itemize}
\item \textbf{Password Hashing:} bcrypt with salt rounds
\item \textbf{Input Validation:} express-validator
\item \textbf{File Upload:} Multer with security configurations
\item \textbf{Session Security:} HTTP-only cookies, CSRF protection
\end{itemize}
...
id & INT (PK) & Unique user identifier \\ \hline
name & VARCHAR(255) & User full name \\ \hline
email & VARCHAR(255) & Unique email address \\ \hline
phone & VARCHAR(20) & Contact number \\ \hline
password & VARCHAR(255) & Hashed password \\ \hline
role & ENUM & user/admin role \\ \hline
created\_at & TIMESTAMP & Account creation time \\ \hline
\end{tabular}
...
\hline
\textbf{Field} & \textbf{Type} & \textbf{Description} \\ \hline
id & INT (PK) & Unique report identifier \\ \hline
user\_id & INT (FK) & Reference to user \\ \hline
incident\_type & VARCHAR(100) & Type of cybercrime \\ \hline
description & TEXT & Detailed description \\ \hline
evidence\_file & VARCHAR(255) & Uploaded file path \\ \hline
incident\_date & DATE & When incident occurred \\ \hline
location & VARCHAR(255) & Incident location \\ \hline
status & ENUM & pending/review/resolved \\ \hline
admin\_response & TEXT & Admin comments \\ \hline
created\_at & TIMESTAMP & Report submission time \\ \hline
\end{tabular}
\caption{Reports Table Schema}
\end{table}

\subsection{Tips Table}
\begin{table}[H]
\centering
\begin{tabular}{|l|l|l|}
\hline
\textbf{Field} & \textbf{Type} & \textbf{Description} \\ \hline
id & INT (PK) & Unique tip identifier \\ \hline
title & VARCHAR(255) & Tip title \\ \hline
content & TEXT & Tip content \\ \hline
created\_at & TIMESTAMP & Creation time \\ \hline
\end{tabular}
\caption{Tips Table Schema}
\end{table}
...
\item Secure session management with HTTP-only cookies
\item Session expiration after 24 hours
\item Protection against brute force attacks
\end{itemize}

\subsection{Input Validation}
\begin{itemize}
\item Client-side validation for user experience
...
\begin{itemize}
\item File type validation (images, PDFs, documents only)
\item File size limits (5MB maximum)
\item Secure storage in isolated directory
\item Controlled access through authentication
\end{itemize}
...
\node (client) [draw, rectangle] {Client Browser};
\node (server) [draw, rectangle, below of=client] {Express.js Server};
\node (db) [draw, rectangle, below of=server] {MySQL/PostgreSQL};
\node (storage) [draw, rectangle, right of=server, xshift=2cm] {File Storage};

\draw[->] (client) -- node[right] {HTTPS} (server);
\draw[->] (server) -- node[right] {SQL Queries} (db);
\draw[->] (server) -- node[above] {File I/O} (storage);
\end{tikzpicture}
...
\section{Backend Development Tools}

\subsection{Node.js and Express.js}
\textbf{Purpose:} Server-side application framework

\textbf{Features Used:}
\begin{itemize}
\item RESTful API routing
\item Middleware for authentication
...
\textbf{Purpose:} Secure password storage
...
\textbf{Purpose:} Handle multipart/form-data for file uploads
...
\subsection{MySQL/PostgreSQL}
\textbf{Purpose:} Relational database for data persistence
...
\subsection{EJS Templating}
\textbf{Purpose:} Server-side rendering of dynamic content
...
\textbf{Purpose:} Utility-first CSS framework for responsive design
...
\item Dark theme support
\end{itemize}

\section{Security and Validation Tools}

\subsection{Input Validation}
\textbf{Client-side:} HTML5 validation attributes
\textbf{Server-side:} Custom validation middleware

\subsection{Session Management}
\textbf{Tool:} express-session
\textbf{Configuration:}
\begin{lstlisting}[language=JavaScript]
app.use(session({
  secret: 'secret-key',
...
We built CyberGuard using a three-tier architecture that splits the system into presentation, business logic, and data layers. This separation makes the code easier to maintain and scale. Each layer can be developed and deployed independently, which really helped us during the development process.

For the frontend, we used EJS templates along with HTML5, CSS3, and JavaScript to create responsive web pages. This layer takes care of everything users see and interact with - from filling out forms to viewing their reports. We made sure it works smoothly on desktops, tablets, and phones.

The middle layer runs on Node.js with Express.js, handling all the core functionality through RESTful APIs. Here's where we process user logins, validate inputs, enforce security rules, and manage integrations. We kept the code modular so adding new features later wouldn't be a headache.

At the bottom, we have the database layer supporting both MySQL and PostgreSQL. We added an abstraction layer so we can switch between databases without rewriting code. This layer manages all data storage, optimizes queries, and keeps everything secure and consistent.

\begin{center}
    
    \includegraphics[width=0.5\linewidth]{System_Arch.png}
    \newline
...
\node (register) [decision, below of=start, yshift=-1.75cm] {Registered?};
\node (signup) [process, left of=register, xshift=-2.5cm] {Registration};
\node (login) [process, below of=register, yshift=-2cm] {Login};
...
We designed our database schema to handle cybercrime reports efficiently while keeping data relationships intact. The schema has several tables that work together to store user information, incident reports, and educational content.

The Users table is where we store all account information - names, emails, phone numbers, and encrypted passwords. We included role fields to separate regular users from admins, which helps control who can access what features.
...
Security was our top priority throughout development. Since we're dealing with sensitive cybercrime data, we couldn't take any shortcuts. We implemented multiple security layers following industry standards like OWASP guidelines.

We use bcrypt to hash passwords before storing them \citep{bcrypt2023hashing}, so even if someone gets into our database, they can't read the actual passwords. For sessions, we went with HTTP-only cookies that expire after 24 hours to prevent hijacking attempts.
...
We built the backend using Node.js and Express.js, which gave us the performance and flexibility we needed. Breaking everything into separate modules made testing and maintenance much simpler.

Our authentication module handles everything from user registration to login and logout. We're using bcrypt with 10 salt rounds for password hashing, which protects against rainbow table and brute force attacks. The express-session middleware manages user sessions with secure settings.
